export const HOSHITOKEN_CONTRACT_ADDRESS =
  '0x93fBAfea3Ae1C7855910D5b3fd5B469122D347Ae';

export const HOSHITOKEN_ABI = [
  {
    inputs: [
      { internalType: 'address', name: 'initialOwner', type: 'address' },
      { internalType: 'address', name: '_HoshiNFTAddress', type: 'address' },
    ],
  ...
  },
  {
    ...
    outputs: [{ internalType: 'contract HoshiNFT', name: '', type: 'address' }],

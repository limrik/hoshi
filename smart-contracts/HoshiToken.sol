...
contract HoshiToken is ERC20, ERC20Burnable, Ownable {
    ...
    uint256 public constant TOKENS_PER_ETH = 1000000; // 1 million tokens per 1 ETH

    uint256 public subscriptionFeeETH = 1000000000 wei; // Fee to subscribe (0.000000001 ETH)
